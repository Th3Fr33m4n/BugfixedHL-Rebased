...
DEFINE_HUD_ELEM(CHudNightvision);

void CHudNightvision::Init(void)
{
	BaseHudClass::Init();
	
	m_fOn = 0;

	HookMessage<&CHudNightvision::MsgFunc_Nightvision>("Nightvision");
	HookMessage<&CHudNightvision::MsgFunc_Flashlight>("Flashlight");
...
void CHudNightvision::VidInit(void)
{
...
void CHudNightvision::Draw(float flTime)
{
