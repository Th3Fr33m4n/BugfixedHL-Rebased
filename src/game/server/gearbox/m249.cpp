...
BOOL CM249::Deploy()
{
	...
	UpdateTape();
	return DefaultDeploy("models/v_saw.mdl", "models/p_saw.mdl", M249_DRAW, "m249");
}
...
void CM249::Reload(void)
{
	...
	if (DefaultReload(M249_MAX_CLIP, M249_RELOAD_START, 1.3, pev->body))
	{
		m_bReloading = true;
		m_flNextPrimaryAttack = UTIL_WeaponTimeBase() + 3.7;
